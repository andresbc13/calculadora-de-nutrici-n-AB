...
// SEC-4: sanitize user text before any DOM insertion
...
function applyMacroPreset(preset, btn) {
...
// EXPORT
// ═══════════════════════════════════════════════════════
function copySummary(){const t=$('professionalSummary').textContent;navigator.clipboard.writeText(t).then(()=>alert('Resumen copiado.')).catch(()=>alert('No se pudo copiar. Selecciona el texto manualmente.'));}
